...
qpos = HDF5.h5open(fid->fid["qpos"][:, 1:200000], "/home/emil/Downloads/coltrane_2021_08_14_1_qpos.h5", "r")
#qpos[3, :] .+= initial_root_z
#qpos[1:3, :] .*= .8
#qpos[3, :] .-= min_xpos
#qpos[1, :] .-= qpos[1, 1]
#qpos[2, :] .-= qpos[2, 1]
qvel = zeros(model.nv, 200000)
act = zeros(model.na, 200000)
...
HDF5.h5open("src/environments/assets/com_trajectory3.h5", "w") do fid
    fid["com"] = com
    fid["xmat"] = xmat
    fid["xquat"] = xquat
    fid["qpos"] = qpos[:, 1:200000]
