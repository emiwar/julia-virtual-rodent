...
function actor_logged(actor_critic::VariationalEncDec, state, params, action=nothing, latent_eps=nothing)
    ...
    (;action, mu, sigma, loglikelihood, latent, latent_mu,
      latent_logsigma, latent_eps, pairs(activation_log)...)
end