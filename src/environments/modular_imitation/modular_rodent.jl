...
function proprioception(rodent::ModularRodent)
    (
        hand_L = (
            ...
            wrist_angle_vel = sensor(rodent, "hand_L/wrist_angle_vel" |> Symbol |> Val),
            finger_angle_vel = sensor(rodent, "hand_L/finger_angle_vel" |> Symbol |> Val),
            ...
            finger_zz = sensor(rodent, "hand_L/finger_global_zaxis" |> Symbol |> Val)[3],
        ...
        arm_L = (
            ...
            elbow_angle_vel = sensor(rodent, "arm_L/elbow_angle_vel" |> Symbol |> Val),
            shoulder_sup_vel = sensor(rodent, "arm_L/shoulder_sup_vel" |> Symbol |> Val),
            shoulder_vel = sensor(rodent, "arm_L/shoulder_vel" |> Symbol |> Val),
            scapula_extend_vel = sensor(rodent, "arm_L/scapula_extend_vel" |> Symbol |> Val),
            scapula_abduct_vel = sensor(rodent, "arm_L/scapula_abduct_vel" |> Symbol |> Val),
            scapula_supinate_vel = sensor(rodent, "arm_L/scapula_supinate_vel" |> Symbol |> Val),
        ...
        hand_R = (
            ...
            wrist_angle_vel = sensor(rodent, "hand_R/wrist_angle_vel" |> Symbol |> Val),
            finger_angle_vel = sensor(rodent, "hand_R/finger_angle_vel" |> Symbol |> Val),
            ...
            finger_zz = sensor(rodent, "hand_R/finger_global_zaxis" |> Symbol |> Val)[3],
        ...
        arm_R = (
            ...
            elbow_angle_vel = sensor(rodent, "arm_R/elbow_angle_vel" |> Symbol |> Val),
            shoulder_sup_vel = sensor(rodent, "arm_R/shoulder_sup_vel" |> Symbol |> Val),
            shoulder_vel = sensor(rodent, "arm_R/shoulder_vel" |> Symbol |> Val),
            scapula_extend_vel = sensor(rodent, "arm_R/scapula_extend_vel" |> Symbol |> Val),
            scapula_abduct_vel = sensor(rodent, "arm_R/scapula_abduct_vel" |> Symbol |> Val),
            scapula_supinate_vel = sensor(rodent, "arm_R/scapula_supinate_vel" |> Symbol |> Val),
        ...
        foot_L = (
            ...
            knee_angle_vel = sensor(rodent, "foot_L/knee_angle_vel" |> Symbol |> Val),
            ankle_angle_vel = sensor(rodent, "foot_L/ankle_angle_vel" |> Symbol |> Val),
            toe_angle_vel = sensor(rodent, "foot_L/toe_angle_vel" |> Symbol |> Val),
            ...
            toe_zz = sensor(rodent, "foot_L/toe_global_zaxis" |> Symbol |> Val)[3],
        ...
        leg_L = (
            ...
            hip_supinate_vel = sensor(rodent, "leg_L/hip_supinate_vel" |> Symbol |> Val),
            hip_abduct_vel = sensor(rodent, "leg_L/hip_abduct_vel" |> Symbol |> Val),
            hip_extend_vel = sensor(rodent, "leg_L/hip_extend_vel" |> Symbol |> Val),
            knee_angle_vel = sensor(rodent, "leg_L/knee_angle_vel" |> Symbol |> Val),
        ...
        foot_R = (
            ...
            knee_angle_vel = sensor(rodent, "foot_R/knee_angle_vel" |> Symbol |> Val),
            ankle_angle_vel = sensor(rodent, "foot_R/ankle_angle_vel" |> Symbol |> Val),
            toe_angle_vel = sensor(rodent, "foot_R/toe_angle_vel" |> Symbol |> Val),
            ...
            toe_zz = sensor(rodent, "foot_R/toe_global_zaxis" |> Symbol |> Val)[3],
        ...
        leg_R = (
            ...
            hip_supinate_vel = sensor(rodent, "leg_R/hip_supinate_vel" |> Symbol |> Val),
            hip_abduct_vel = sensor(rodent, "leg_R/hip_abduct_vel" |> Symbol |> Val),
            hip_extend_vel = sensor(rodent, "leg_R/hip_extend_vel" |> Symbol |> Val),
            knee_angle_vel = sensor(rodent, "leg_R/knee_angle_vel" |> Symbol |> Val),
            ankle_angle_vel = sensor(rodent, "leg_R/ankle_angle_vel" |> Symbol |> Val),
        ...
        torso = (
            ...
            lumbar_extend_vel = sensor(rodent, "torso/lumbar_extend_vel" |> Symbol |> Val),
            lumbar_bend_vel = sensor(rodent, "torso/lumbar_bend_vel" |> Symbol |> Val),
            lumbar_twist_vel = sensor(rodent, "torso/lumbar_twist_vel" |> Symbol |> Val),
        ...
        head = (
            ...
            atlas_vel = sensor(rodent, "head/atlas_vel" |> Symbol |> Val),
            atlant_extend_vel = sensor(rodent, "head/atlant_extend_vel" |> Symbol |> Val),
            mandible_vel = sensor(rodent, "head/mandible_vel" |> Symbol |> Val),
            cervical_extend_vel = sensor(rodent, "head/cervical_extend_vel" |> Symbol |> Val),
            cervical_bend_vel = sensor(rodent, "head/cervical_bend_vel" |> Symbol |> Val),
            cervical_twist_vel = sensor(rodent, "head/cervical_twist_vel" |> Symbol |> Val),
