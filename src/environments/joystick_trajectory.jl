...
function JoystickTrajectory()
    ...
    add_static!(traj, rand(500:2000),  0.5 + rand(), 0.0, 0.05 + rand()*0.02)
    add_static!(traj, rand(20:100),   0.0, -1.5 + rand()*3.0, 0.06)
    ...
    add_static!(traj, rand(100:2000),  0.2 + rand()*0.5, 0.0, 0.04 + rand()*0.04)
    ...
    add_static!(traj, rand(150:400),   0.05 + rand()*0.25,  0.0, 0.08 + rand()*0.06)
    add_static!(traj, rand(100:2000),  0.5 + rand(), 0.0, 0.04 + rand()*0.04)
